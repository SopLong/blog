    ...
    <div class="login-vue" :style="bg">
        <el-form ref="form" :model="form" label-width="80px">
            <div class="container">
                ...
                <div class="input-c">
                    <Input prefix="ios-contact" v-model="form.name" placeholder="用户名" clearable @on-blur="verifyAccount"/>
                    <p class="error">{{accountError}}</p>
                </div>
                <div class="input-c">
                    <Input type="password" v-model="form.password" prefix="md-lock" placeholder="密码" clearable @on-blur="verifyPwd"/>
